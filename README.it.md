...
Versione corrente: **26.38 - Melancholy Taco** (vedi [`CHANGELOG.md`](CHANGELOG.md)). La prima
...
Versione corrente: **26.38 - Melancholy Taco**. Il dettaglio delle modifiche per versione e' in
...
pre-stable. NodeInfo e User-Agent usano la versione tecnica (`26.38`); il
footer mostra `26.38 - Melancholy Taco`.
