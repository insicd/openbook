...
<div
    id="ob-post-list"
    @if ($homeFeed ?? false) class="ob-home-feed" @endif
    data-infinite-scroll
    @if ($homeFeed ?? false) data-home-feed data-retry-label="{{ __('openbook.infinite_scroll.retry') }}" @endif
    ...
    data-error-label="{{ ($homeFeed ?? false) ? __('openbook.infinite_scroll.retry_error') : __('openbook.infinite_scroll.error') }}"
>
