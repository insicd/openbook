...
return [
    ...
    'admin' => [
        ...
        'relays' => [
            ...
            'relay_placeholder' => 'https://relay.example/inbox or @relay@instance.example',
            'relay_url_help' => 'For a Mastodon relay enter the inbox URL supplied by its operator. For a relay actor enter its federated identity, for example @relay@instance.example; the full ActivityPub Actor URI is also accepted.',
