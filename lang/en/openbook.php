...
return [
    ...
    'events' => [
        'title' => 'Events',
        'subtitle' => 'Discover upcoming events published across the Fediverse.',
        'upcoming' => 'Upcoming',
        'archive' => 'Past events',
        'your_events' => 'Your events',
        'your_events_help' => 'Direct events and events you are interested in.',
        ...
        'location' => 'Location',
        'online' => 'Online event',
        'organized_by' => 'Created by',
        'distributed_by' => 'Distributed by',
        'participants_count' => '{0} No participants|{1} :count participant|[2,*] :count participants',
        'likes_count' => '{0} No likes|{1} :count like|[2,*] :count likes',
        'participants_label' => 'Participants',
        'likes_label' => 'Likes',
        'category' => 'Category',
        'source' => 'Open the original page',
        'external_link' => 'Open the event website',
        'cancelled' => 'Cancelled event',
        'tentative' => 'Tentative date',
        'postponed' => 'Postponed event',
        'deleted_title' => 'Event no longer available',
        'deleted_body' => 'This event was deleted by its origin server.',
        'back' => 'Back to events',
        'interested' => 'Interested',
        'not_interested' => 'Not interested anymore',
        'join' => 'I’ll attend',
        'leave' => 'I won’t attend',
        'join_pending' => 'Participation request sent',
        'join_accepted' => 'Participation confirmed',
        'join_rejected' => 'Participation request rejected',
        'pending_participations' => 'Participation requests',
        'pending_participations_help' => 'Choose who may attend this event.',
        'badge' => 'Event',
        'share' => 'Share',
        'edit' => 'Edit',
        'cancel' => 'Cancel event',
        'cancel_confirm' => 'Cancel this event? It will remain visible as cancelled.',
        'delete' => 'Delete event',
        'delete_confirm' => 'Permanently delete this event?',
        'deleted' => 'Event deleted.',
        'sensitive_content' => 'Sensitive content: show event details',
        'composer' => [
            'create' => 'Create event',
            'title' => 'Create an event',
            'subtitle' => 'Collect the information needed to publish an event across the Fediverse.',
            'edit_title' => 'Edit event',
            'edit_subtitle' => 'Update the event information and publish the changes across the Fediverse.',
            'back' => 'Back to events',
            'preview_badge' => 'Preview',
            'details_title' => 'Main information',
            'details_help' => 'Present the event clearly and add a recognizable cover.',
            'name' => 'Title',
            'name_placeholder' => 'Event name',
            'description' => 'Description',
            'description_placeholder' => 'Explain what will happen, who it is for and how to attend…',
            'description_help' => 'You can use Markdown, hashtags and mentions.',
            'cover' => 'Cover image',
            'cover_help' => 'One image, displayed as a cover in event cards.',
            'cover_replace_help' => 'Upload a new image only if you want to replace the current cover.',
            'cover_alt' => 'Cover alternative text',
            'sensitive' => 'Initially hide the cover and description',
            'sensitive_help' => 'People opening the event can choose whether to reveal this content.',
            'when_title' => 'Date and time',
            'when_help' => 'The end date is optional; the time zone will always be shown explicitly.',
            'start' => 'Starts',
            'end' => 'Ends',
            'end_help' => 'Leave empty if the duration is not defined.',
            'timezone' => 'Time zone',
            'timezone_help' => 'We suggested your device’s time zone; change it if the event takes place elsewhere.',
            'where_title' => 'Where it takes place',
            'where_help' => 'Tell people where they can meet.',
            'mode' => 'This event takes place…',
            'mode_physical' => 'At a place',
            'mode_online' => 'Online',
            'mode_hybrid' => 'At a place and online',
            'participation_url' => 'Participation or registration link',
            'city' => 'City',
            'city_catalog_unavailable' => 'The city catalog is not installed, so location selection is unavailable.',
            'venue' => 'Venue name',
            'venue_placeholder' => 'Theatre, club, community centre…',
            'address' => 'Address',
            'address_placeholder' => 'Street and number',
            'publish_title' => 'Attendance and visibility',
            'publish_help' => 'Choose how people can join and discover the event.',
            'join_mode' => 'How can people attend?',
            'join_free' => 'Anyone can attend',
            'join_restricted' => 'Attendance must be approved',
            'join_external' => 'Registration on an external website is required',
            'listed' => 'Show this event in public lists and search',
            'listed_help' => 'If disabled, the event remains accessible and shareable through its link.',
            'submit_help' => 'After publishing, you will immediately see the event details.',
            'submit' => 'Publish event',
            'update_submit' => 'Save changes',
            'created' => 'Event published.',
            'updated' => 'Event updated.',
            'error_summary' => 'Check the information you entered:',
            'errors' => [
                'participation_url_required' => 'Enter the link needed to attend or register.',
                'participation_url_https' => 'The participation link must start with https://.',
                'physical_location_required' => 'Enter at least a city, venue name or address.',
            ],
        ],
        'infinite_scroll' => [
    ...
    'profile' => [
        ...
        'actions_menu' => 'More profile actions',
    ...
    'posts' => [
        ...
        'video_status_failed' => 'processing failed',
        'video_deleted' => 'The pending publication was deleted.',
    ...
    'follow' => [
        ...
        'auto_announce_help' => 'New public posts from this contact will be shared from your account. Posts already on the instance will not be reshared.',
        'auto_announce_disable_help' => 'New posts from this contact will no longer be shared automatically. Shares already published stay visible.',
        'auto_announce_enable_confirm' => 'Turn on',
        'auto_announce_disable_confirm' => 'Turn off',
    ...
    'notifications' => [
        ...
        'messages' => [
            ...
            'event_join_accepted' => ':name accepted your event participation.',
            'event_join_rejected' => ':name declined your event participation.',
            'event_join_request' => ':name requested to attend your event.',
            'event_joined' => ':name will attend your event.',
        ],
    ],
    ...
    'messages' => [
        ...
        'errors' => [
            ...
            'event_unavailable' => 'This event is unavailable or not visible.',
        ],
    ],
    ...
    'admin' => [
        ...
        'settings' => [
            ...
            'contact_email_help' => 'Public address for reports and contacting the administrators.',
            'contact_account' => 'Instance contact account',
            'contact_account_none' => 'None',
            'contact_account_help' => 'Optional. Choose an active administrator to show as a contact in the public instance information.',
            ...
            'video_title' => 'Video support',
            'video_help' => 'Optional feature: it requires FFmpeg and ffprobe plus a dedicated CLI worker for transcoding. PHP and reverse proxy limits must allow the configured size.',
            'video_enabled' => 'Enable local video attachments',
            'video_ffmpeg_path' => 'FFmpeg path',
            'video_ffprobe_path' => 'ffprobe path',
            'video_max_upload_mb' => 'Maximum video size (MB)',
            'video_passthrough_max_mb' => 'Maximum size without transcoding (MB)',
            'video_max_duration_seconds' => 'Maximum video duration (seconds)',
            'video_max_dimension' => 'Maximum long edge (pixels)',
            'video_max_frame_rate' => 'Maximum frame rate (fps)',
            'video_tools_available' => 'Tools available — :ffmpeg; :ffprobe',
            'video_tools_unavailable' => 'FFmpeg/ffprobe unavailable: :error',
            ...
            'world_moderation_title' => 'World moderation',
            'world_hide_content_warnings' => 'Hide posts with content warnings from World',
            'world_hide_content_warnings_help' => 'Posts remain available in other sections and through their direct link, but do not appear in the World timeline.',
            'forced_content_warning_hashtags' => 'Hashtags requiring a content warning',
            'forced_content_warning_hashtags_help' => 'Enter up to 100, one per line or separated by spaces or commas. The hash sign is optional. Matching posts receive a local warning and, when the option above is enabled, are excluded from World.',
            'save' => 'Save settings',
        ...
        'relays' => [
            ...
            'intro' => 'Configure the instance federation relays. Adding one only stores its configuration; the federated relationship starts when you select “Subscribe”.',
            'traffic_warning' => 'A relay can significantly increase imported content, storage, bandwidth, and moderation work. Enable it only if you want to receive that public stream.',
            'local_actor' => 'Instance technical identity',
            'protocol' => 'Technology',
            'protocol_mastodon' => 'Mastodon relay',
            'protocol_actor' => 'Relay actor (Mobilizon/Gancio)',
            'protocol_litepub' => 'LitePub relay (Pleroma/Akkoma)',
            'mastodon_address' => 'Relay inbox URL',
            'mastodon_placeholder' => 'https://relay.example/inbox',
            'mastodon_address_help' => 'Enter the inbox URL supplied by the Mastodon relay operator.',
            'actor_address' => 'Relay Actor identity',
            'actor_placeholder' => '@relay@instance.example',
            'actor_address_help' => 'Enter the federated identity of the relay Actor. Its full ActivityPub URI is also accepted.',
            'litepub_address_help' => 'Enter the federated identity or ActivityPub URI of the LitePub relay Actor.',
            'receive_enabled' => 'Receive content from this relay',
            'publish_enabled' => 'Publish public content to this relay',
            'inactive_help' => 'Receiving and publishing preferences apply after the relay accepts the subscription.',
            'add' => 'Add relay',
            'remove' => 'Remove',
            'subscribe' => 'Subscribe',
            ...
            'created' => 'Relay added as an inactive configuration.',
            'updated' => 'Relay options updated.',
            'deleted' => 'Relay configuration removed.',
            'subscription_queued' => 'Subscription request queued.',
            'unsubscription_queued' => 'Relay deactivated; remote cancellation has been queued.',
            'invalid_url' => 'Enter a valid HTTPS URL without credentials, query string or fragment.',
            'unsupported_protocol' => 'The selected relay technology is not supported yet.',
            'actor_unavailable' => 'The supplied identity does not resolve to a valid and reachable Application or Service relay actor.',
            'actor_inbox_missing' => 'The relay actor does not expose a usable inbox endpoint.',
            'duplicate' => 'This relay endpoint is already configured.',
            'admin_required' => 'Only an administrator can manage relays.',
            'cannot_delete_active' => 'An active subscription must be disabled first.',
            'state_idle' => 'Inactive',
            'state_pending' => 'Pending',
            'state_accepted' => 'Accepted',
            'state_awaiting_reciprocal' => 'Accepted, awaiting reciprocal Follow',
            'state_rejected' => 'Rejected',
            'state_failed' => 'Failed',
            'receives' => 'receiving enabled',
            'does_not_receive' => 'receiving disabled',
            'publishes' => 'publishing enabled',
            'does_not_publish' => 'publishing disabled',
            'last_success' => 'Last successful exchange',
        ...
        'database' => [
            'title' => 'Database',
            'intro' => 'Operational tables that can grow over time (raw inbox, failed jobs, cache and video publications). Each table applies its stated retention; posts, users and published media are never touched.',
            'total_size' => 'Estimated size (listed tables)',
            'total_purgeable' => 'Purgeable rows',
            'col_table' => 'Table',
            'col_rows' => 'Rows',
            'col_size' => 'Size',
            'col_purgeable' => 'Purgeable',
            'purge' => 'Clean up',
            'purge_all' => 'Clean up all',
            'confirm_all' => 'Delete every row past its retention period from the listed tables?',
            'confirm_table' => 'Delete rows past their retention period from :table?',
