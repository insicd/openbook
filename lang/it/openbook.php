...
return [
    ...
    'posts' => [
        'video_queued' => 'Il video e stato caricato e il post verra pubblicato al termine dell\'elaborazione.',
        ...
        'video_deleted' => 'La pubblicazione in attesa e stata eliminata.',
    ...
    'settings' => [
        ...
        'discoverable_help' => 'Se disattivato, non comparirai tra "Persone da seguire" ne nei risultati di ricerca di questa istanza, e il tuo profilo federato dichiarera\' discoverable: false (directory Mastodon e servizi simili). Resti raggiungibile tramite il tuo indirizzo diretto.',
        'indexable_label' => 'Consenti l\'indicizzazione dei miei post pubblici',
        'indexable_help' => 'Se attivo, i tuoi post pubblici possono comparire nella ricerca testuale di questa istanza e di altri server compatibili (Mastodon, FEP-5feb). E\' un consenso, non una garanzia: i contenuti pubblici restano comunque visibili e copiabili.',
    ...
    'messages' => [
        ...
        'share_profile_intro' => 'Invia questo profilo in un messaggio privato. Il destinatario aprira\' la pagina su questa istanza, dove puo\' seguirlo.',
        ...
        'errors' => [
            ...
            'profile_unavailable' => 'Questo profilo non e\' disponibile.',
        ],
    ],
    ...
    'communities' => [
        ...
        'suggested_remote_help' => 'Altri utenti di :domain sono gia\' iscritti a questi Group remoti: puoi aprire il profilo e richiedere l\'iscrizione.',
    ...
    'admin' => [
        ...
        'settings' => [
            ...
            'video_help' => 'Funzionalita opzionale: richiede FFmpeg e ffprobe e, per la transcodifica, un worker CLI dedicato. I limiti PHP e del reverse proxy devono consentire la dimensione configurata.',
        ...
        'appearance' => [
            ...
            'preview_banner' => 'Anteprima: questa non e\' la home reale. Il CSS bozza non e\' ancora pubblico.',
            'save' => 'Salva aspetto',
            'saved' => 'Aspetto salvato. Il CSS e\' ora visibile sul sito pubblico.',
