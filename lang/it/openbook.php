...
return [
    ...
    'admin' => [
        ...
        'database' => [
            'title' => 'Database',
            'intro' => 'Tabelle operative che possono crescere nel tempo (inbox grezzo, job falliti, cache). La pulizia elimina solo righe più vecchie di :hours ore; post, utenti e federazione non vengono toccati.',
            ...
            'confirm_all' => 'Eliminare tutte le righe più vecchie di :hours ore dalle tabelle elencate?',
            'confirm_table' => 'Eliminare le righe più vecchie di :hours ore da :table?',
